        ...
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 col-lg-3 mb-4">
                <div class="materi-box">
                    <img src="{{ asset('images/materi/OrganPencernaan.png') }}" alt="Pencernaan" class="img-fluid mb-2" style="max-height: 150px;">
                    <div class="topik-text">MATERI SISTEM PENCERNAAN</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-3 mb-4">
                <div class="materi-box">
                    <img src="{{ asset('images/materi/SistemPernapasan.png') }}" alt="Pencernaan" class="img-fluid mb-2" style="max-height: 150px;">
