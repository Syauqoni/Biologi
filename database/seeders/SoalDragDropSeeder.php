...
class SoalDragDropSeeder extends Seeder
{
    public function run()
    {
        ...
        [
            ...
            'nomor' => 6,
            'pertanyaan' => 'Urutkan peredaran darah besar:',
            'gambar' => 'SarafLutut.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Aorta",
        ...
        [
            'slug' => 'sistem-peredaran-darah',
            'nomor' => 7,
            'pertanyaan' => 'Urutkan peredaran darah kecil',
            'gambar' => 'Otak.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Ventrikel kanan",
        ...
        [
            'slug' => 'sistem-eksresi',
            'nomor' => 6,
            'pertanyaan' => 'Urutkan proses pembentukan urine:',
            'gambar' => 'SarafLutut.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Filtrasi",
        ...
        [
            'slug' => 'sistem-eksresi',
            'nomor' => 7,
            'pertanyaan' => 'Urutkan perjalanan urine',
            'gambar' => 'Otak.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Ginjal",
        ...
        [
            ...
            'nomor' => 6,
            'pertanyaan' => 'Urutkan proses pelepasan adrenaline',
            'gambar' => 'SarafLutut.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Stres",
                "Sinyal ke kelenjar adrenal",
                "Pelepasan adrenaline",
                "Detak jantung naik"
            ],
            'poin' => 15,
            'penjelasan' => '',
        ...
        [
            'slug' => 'sistem-endokrin',
            'nomor' => 7,
            'pertanyaan' => 'Urutkan proses pengaturan gula darah:',
            'gambar' => 'Otak.png',
            'opsi' => ["A", "B", "C", "D"],
            'urutan' => [
                "Gula darah naik",
